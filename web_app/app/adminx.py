...
#              "content": "<h3> Welcome to Xadmin! </h3><p>Join Online Group: <br/>QQ Qun : 1176868066</p>"},
...
class GlobalSetting(object):
    site_title = u'数据后台管理系统'
    site_header = u"股票-数据录管理系统"
    site_footer = u'个人私有 Copyright © 2020.  All Rights Reserved'
